// src/renderer/src/libraries/maya.ts
// ============================================================================
// FLOWPINS: AUTODESK MAYA NODE LIBRARY
// Node specs for Maya-specific nodes.
// Translations live in /translators/maya.ts
// ============================================================================
...
export const MAYA_NODES: Record<string, NodeSpec> = {
  ...
  "maya_get_selection": {
    ...
    profile: "App - Maya",
    inputs: [],
    outputs: [{ name: "selection_list", pin_type: "list" }]
  },
